...
function page() {
  return (
    ...
    <DashboardLayout>
      <h1 className='text-2xl pl-1 pb-5 pt-2 font-inherit uppercase text-gray-500 ' >recruiter</h1>
      <div className='border p-3 rounded-ss-xl rounded-se-xl bg-[#212529] w-72 2xl:w-auto xl:w-auto lg:w-auto md:w-auto sm:w-auto '>
        <p className='text-white capitalize text-inherit text-md'>recruiter list</p>
      </div>
